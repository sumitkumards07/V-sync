# V-sync
**V-sync** is a companion app designed to simplify and enhance student life at VIT-AP University.

## 📘 Product Docs

- [UI/UX Design Specification](docs/ui-ux-design-spec.md)
- [Campus Life Feature Roadmap](docs/campus-life-roadmap.md)
- [Campus Supabase Schema](docs/campus-supabase-schema.md)
